function initialize_sate_RS_MTF_noReg()
...
global file_path_F4b file_path_gt;
...
if (strcmp(sate, 'ik'))
    ...
    folder_nir64 = 'E:\remote sense image fusion\Source Images\IKONO\ik_nir64_MTF';
    folder_rgb64 = 'E:\remote sense image fusion\Source Images\IKONO\ik_rgb64_MTF';
...
if (strcmp(sate, 'pl'))
    ...
    % folder_pan_ori = 'ik_pan256' ;
    folder_rgb64 = 'E:\remote sense image fusion\Source Images\Pleiades\pl_rgb64_MTF';
    folder_nir64 = 'E:\remote sense image fusion\Source Images\Pleiades\pl_nir64_MTF';
...
if (strcmp(sate, 'qb'))
    ...
    % folder_pan_ori = 'ik_pan256' ;
    folder_rgb64 = 'E:\remote sense image fusion\Source Images\QuickBird\2_RGB64_MTF';
    folder_nir64 = 'E:\remote sense image fusion\Source Images\QuickBird\2_NIR64_MTF';
...
% end
if (strcmp(sate, 'wv2'))
    folder_rgb256 = 'E:\remote sense image fusion\Source Images\WorldView-2\2_RGB256';    %  RBG image folder name
    folder_nir256 = 'E:\remote sense image fusion\Source Images\WorldView-2\2_NIR256';
    % folder_pan_ori = 'ik_pan256' ;
    folder_rgb64 = 'E:\remote sense image fusion\Source Images\WorldView-2\2_RGB64';
    folder_nir64 = 'E:\remote sense image fusion\Source Images\WorldView-2\2_NIR64';
    folder_pan256 = 'E:\remote sense image fusion\Source Images\WorldView-2\2_PAN256';
    folder_gt256 = 'E:\remote sense image fusion\Source Images\WorldView-2\2_GT256' ;
...
if (strcmp(sate, 'wv3'))
    ...
    % folder_pan_ori = 'ik_pan256' ;
    folder_rgb64 = 'E:\remote sense image fusion\Source Images\WorldView-3\wv3_rgb64_MTF';
    folder_nir64 = 'E:\remote sense image fusion\Source Images\WorldView-3\wv3_nir64_MTF';
...
if (strcmp(sate, 'geo'))
    ...
    % folder_pan_ori = 'ik_pan256' ;
    folder_rgb64 = 'E:\remote sense image fusion\Source Images\GeoEye_1\RGB64_MTF';
    folder_nir64 = 'E:\remote sense image fusion\Source Images\GeoEye_1\NIR64_MTF';
